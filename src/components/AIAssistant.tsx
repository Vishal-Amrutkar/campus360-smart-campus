      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full bg-brand-blue/90 backdrop-blur-md shadow-[0_0_30px_rgba(0,80,255,0.4)] flex items-center justify-center text-white border border-brand-cyan/30 group"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 w-[380px] h-[600px] max-h-[80vh] max-w-[calc(100vw-48px)] glass border border-white/20 rounded-3xl shadow-2xl overflow-hidden flex flex-col"
          >
            {/* Header */}
